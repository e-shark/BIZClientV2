...
//-----------------------------------------------------------------------------
//  Получить очередное задание (для любой компании)
//  Возвращает ID задания. А так-же:
//  pid - ID персоны
//  type - тип задания
//  в буфер Param параметры задания (двоичная структура данных)
...
//      8 - Quality Min Limit                   // Минимальный допуск качаства в процентах от среднего
//      9 - Quality Max Limit                   // Максимальный допуск качаства в процентах от среднего
// Виды LocationType
//      1 - для магазина
//      2 - для города
//      3 - для региона
